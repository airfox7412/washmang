...
function DateNum1(cDate:String) : TDateTime;   { 將中式日期字串轉換為 TDateTime }
...
procedure MoneyBox(aflag:Integer); //錢櫃開啟
...
FUNCTION DateNum1(cDate:String):TDateTime; { 取得日期數字 : TDateTime      }
var
   nYear, nMonth, nDate : word;
begin
   nYear := StrToInt(copy(cDate,1,nYearLen))+1911;
