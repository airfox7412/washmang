...
type
  TWDM = class(TDataModule)
    ...
    hprice: TProfileInteger;
    LINE1: TProfileString;
    LINE2: TProfileString;
    hostname: TProfileString;
    LINE3: TProfileString;
    POS: TProfileString;
    LINE4: TProfileString;
    SingleStorePrint: TProfileInteger;
    LINE5: TProfileString;
    LINE6: TProfileString;
    labkind: TProfileString;
    LINE0: TProfileString;
    Quantity: TProfileString;
    Accessories: TProfileString;
